...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 bg-[#0b0a09]">
      {/* Background Elements */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] bg-[#c2273d]/20 rounded-full blur-[140px]"></div>
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-8 lg:px-12 text-center">
        ...
        >
          <h1 className="text-6xl sm:text-8xl lg:text-9xl xl:text-[11rem] font-serif font-bold text-foreground mb-10 tracking-tighter leading-[0.85] select-none">
            Sergio <br />
            <span className="text-transparent bg-clip-text bg-linear-to-b from-primary via-primary to-[#c9a227] italic pb-4 pr-12">
              Procopio
            </span>
          </h1>
        </motion.div>
        ...
        >
          ...
          <a
            href="#contatti"
            className="group relative overflow-hidden inline-flex min-h-14 items-center justify-center rounded-full bg-primary px-10 py-4 text-xl font-bold text-primary-foreground shadow-[0_8px_30px_rgba(212,162,76,0.22)] transition-[scale,box-shadow] duration-200 ease-out hover:shadow-[0_10px_40px_rgba(212,162,76,0.38)] active:scale-[0.96] hover:no-underline"
          >
            <span className="relative z-10">Mettiamoci in Contatto</span>
            <div className="absolute inset-0 rounded-full bg-linear-to-tr from-[#c9a227] to-primary opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
          </a>
